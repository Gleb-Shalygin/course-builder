<template>
    ...
    >
        ...
        <span class="runner-answer__row">Ваш ответ: <b>{{ selectedLabel }}</b></span>
...
interface TestRunnerResultItemProps {
    item: RunnerResultItem;
}

const props = defineProps<TestRunnerResultItemProps>();
